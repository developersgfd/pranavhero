...
INSERT INTO `hotel`(`hotel_name`, `country`, `state`, `city`, `address`, `zipcode`)
			VALUES  ('Toshali Sands-I','India','ODA','Puri','Konark Marine Drive', 752002),
					('Toshali Sands-II','India','ODA','Puri','Konark Marine Drive', 752002),
					('Toshali Sands-III','India','ODA','Puri','Konark Marine Drive', 752002),
					('Toshali Sands-IV','India','ODA','Puri','Konark Marine Drive', 752002),
					('Toshali Sands-V','India','ODA','Puri','Konark Marine Drive', 752002),
					('Toshali Sands-VI','India','ODA','Puri','Konark Marine Drive', 752002);
...
INSERT INTO `myroom` VALUES (101, 1, 99.00, 2, 100, 'standard', 'Non-AC'),
                            (102, 1, 100.02, 2, 100, 'standard', 'Non-AC'), 
							(412, 1, 99.78, 4, 400, 'double', 'Non-AC'),
                            (306, 1, 99.02, 4, 300, 'double', 'Non-AC'),
                            (408, 1, 102.42, 4, 400, 'suite', 'AC'), 
                            (105, 1, 99.87, 2, 100, 'standard', 'Non-AC'),
                            (203, 1, 104.09, 4, 200, 'double', 'Non-AC'),
                            (212, 1, 102.87, 2, 200, 'deluxe', 'AC'),
                            (406, 1, 109.82, 2, 400, 'standard', 'Non-AC'),
                            (108, 1, 162.98, 4, 100, 'double', 'Non-AC'),
							(103, 2, 104.32, 2, 100, 'deluxe', 'AC'),
                            (202, 2, 126.89, 1, 200, 'standard', 'Non-AC'),
                            (809, 2, 134.67, 2, 800, 'deluxe', 'AC'),
                            (604, 2, 145.04, 4, 600, 'suite', 'AC'),
                            (419, 2, 102.42, 4, 400, 'double', 'Non-AC'), 
                            (403, 2, 87.38, 4, 400, 'suite', 'AC'),
                            (302, 2, 186.89, 2, 300, 'deluxe', 'AC'), 
                            (209, 2, 114.87, 4, 200, 'deluxe', 'AC'),
                            (404, 2, 135.04, 4, 400, 'double', 'Non-AC'),
                            (719, 2, 122.25, 4, 700, 'suite', 'AC'),
                            (999, 2, 555.04, 4, 900, 'double', 'Non-AC'),
                            (661, 2, 232.25, 4, 600, 'suite', 'AC'),
							(302, 3, 403.53, 2, 300, 'double', 'Non-AC'),
                            (109, 3, 478.54, 2, 100, 'deluxe', 'AC'),
                            (808, 3, 403.29, 4, 800, 'deluxe', 'AC'),
                            (311, 3, 389.76, 2, 300, 'standard', 'Non-AC'),
                            (514, 3, 439.45, 2, 500, 'standard', 'Non-AC'), 
                            (502, 3, 393.53, 1, 500, 'standard', 'Non-AC'),
                            (209, 3, 448.58, 4, 200, 'deluxe', 'AC'),
                            (308, 3, 413.39, 4, 300, 'suite', 'AC'),
                            (411, 3, 402.72, 4, 400, 'double', 'Non-AC'),
                            (114, 3, 443.45, 2, 100, 'standard', 'Non-AC'),
                            (206, 4, 123.42, 2, 200, 'suite', 'AC'),
                            (602, 4, 126.87, 4, 600, 'deluxe', 'AC'), 
                            (407, 4, 134.89, 2, 400, 'double', 'Non-AC'),
                            (214, 4, 102.00, 4, 200, 'standard', 'Non-AC'),
                            (305, 4, 102.00, 4, 300, 'double', 'Non-AC'),
                            (306, 4, 114.56, 2, 300, 'suite', 'AC'),
                            (402, 4, 134.32, 1, 400, 'standard', 'Non-AC'), 
                            (507, 4, 119.87, 2, 500, 'suite', 'AC'),
                            (414, 4, 120.98, 4, 400, 'standard', 'Non-AC'),
                            (105, 4, 202.20, 4, 100, 'suite', 'AC'),
                            (605, 5, 359.87, 2, 600, 'standard', 'Non-AC'),
                            (412, 5, 335.78, 4, 400, 'double', 'Non-AC'),
                            (104, 5, 308.90, 2, 100, 'deluxe', 'AC'),
                            (118, 5, 392.78, 4, 100, 'suite', 'AC'),
                            (407, 5, 292.89, 2, 400, 'standard', 'Non-AC'), 
                            (305, 5, 329.78, 4, 300, 'suite', 'AC'),
                            (112, 5, 325.98, 4, 100, 'double', 'Non-AC'), 
                            (204, 5, 326.54, 1, 200, 'deluxe', 'AC'),
                            (618, 5, 337.86, 2, 600, 'standard', 'Non-AC'), 
                            (507, 5, 327.54, 4, 500, 'suite', 'AC'),
							(310, 5, 512.00, 4, 300, 'suite', 'AC'),
                            (122, 5, 312.12, 4, 100, 'double', 'Non-AC'),
                            (214, 5, 334.12, 1, 200, 'deluxe', 'AC'),
                            (617, 5, 350.21, 2, 600, 'standard', 'Non-AC'),
                            (523, 5, 311.11, 4, 500, 'suite', 'AC'),
							(206, 6, 123.42, 2, 200, 'suite', 'AC'),
                            (602, 6, 126.87, 4, 600, 'deluxe', 'AC'), 
                            (407, 6, 134.89, 2, 400, 'double', 'Non-AC'),
                            (214, 6, 102.00, 4, 200, 'standard', 'Non-AC'),
                            (305, 6, 102.00, 4, 300, 'double', 'Non-AC'), 
                            (306, 6, 114.56, 2, 300, 'suite', 'AC'),
                            (402, 6, 134.32, 1, 400, 'standard', 'Non-AC'), 
                            (507, 6, 119.87, 2, 500, 'suite', 'AC'),
                            (414, 6, 120.98, 4, 400, 'standard', 'Non-AC'),
                            (105, 6, 202.20, 4, 100, 'suite', 'AC');
...
INSERT INTO `room_discount` VALUES (101, 1, 25, '2020-12-19','2020-12-21'), (102, 1, 20, '2020-11-21','2020-11-22'), (105, 1, 35, '2020-12-21','2020-12-29'),(406, 1, 15, '2020-12-24','2020-12-30'),(108, 1, 10, '2020-11-21','2020-11-28'),
                                    (103, 2, 10, '2020-11-21','2020-11-22'), (202, 2, 20, '2020-11-21','2020-11-22'), (809, 2, 10, '2020-12-11','2020-12-29'), (302, 2, 30, '2020-12-21','2020-12-29'),
                                    (302, 3, 10, '2020-12-19','2020-12-22'), (502, 3, 35, '2020-12-09','2020-12-11'), (109, 3, 30, '2020-11-21','2020-11-22'), (308, 3, 15, '2020-12-21','2020-12-29'), 
                                    (206, 4, 25, '2020-12-03','2020-12-22'), (402, 4, 40, '2020-12-23','2020-12-31'), (407, 4, 20, '2020-11-21','2020-11-22'), (414, 4, 10, '2020-11-21','2020-11-22'),
                                    (605, 5, 20, '2020-11-21','2020-11-22'), (204, 5, 15, '2020-12-22','2020-12-29'), (112, 5, 15, '2020-11-13','2020-11-15'), (305, 5, 35, '2020-11-09','2020-11-11'),
                                    (206, 6, 25, '2020-12-03','2020-12-21'), (402, 6, 40, '2020-12-23','2020-12-30'), (407, 6, 20, '2020-11-09','2020-11-11'), (414, 6, 10, '2020-11-13','2020-11-21');
...
INSERT INTO `reserves` VALUES (1, 101, 1, 2, '2020-12-18','2020-12-21'), (2, 102, 1, 2, '2020-1-01','2020-1-03'), 
							  (3, 105, 1, 3, '2020-12-15','2020-12-19'), (4, 406, 1, 1, '2020-1-14','2020-1-15'),
							  (5, 108, 1, 1, '2020-2-03','2020-2-04'), (6, 103, 2, 1, '2020-1-13','2020-1-14'), 
							  (7, 202, 2, 2, '2020-12-02','2020-12-04'), (8, 809, 2, 1, '2020-12-09','2020-12-10'),
                              (7, 302, 2, 2, '2020-12-02','2020-12-04'), (8, 604, 2, 1, '2020-12-09','2020-12-10'),
							  (9, 302, 2, 3, '2020-1-17','2020-1-19'), (10, 302, 3, 1, '2020-12-29','2020-12-30'), 
							  (11, 502, 3, 3, '2020-12-16','2020-12-18'), (12, 109, 3, 3, '2020-4-02','2020-4-06'), 
							  (13, 308, 3, 1, '2020-1-03','2020-1-04'), (14, 206, 4, 2, '2020-1-03','2020-1-05'), 
							  (15, 402, 4, 4, '2020-12-14','2020-12-17'), (16, 605, 5, 2, '2020-12-13','2020-12-15'),
                              (17, 206, 6, 2, '2020-12-13','2020-12-15'), (18, 402, 6, 4, '2020-12-13','2020-12-15');
